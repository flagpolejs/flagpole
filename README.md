...
## Tetsing  with Chromium

We now have the capability to use headless Chromium to test.  This allows us to test HTML containing Javascript.  To utilize Chromium for testing add a BrowserOptions configuration object when calling the Scenario.
