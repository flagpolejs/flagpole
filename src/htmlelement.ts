...
export class HTMLElement extends DOMElement implements iValue, iDOMElement {
  ...
  public async click(scenario: iScenario): Promise<void>;
  public async click(message: string, callback: Function): Promise<void>;
  public async click(message: string, scenario: iScenario): Promise<void>;
  public async click(
    ...
    // Is this a button?
      ...
      if (type.isNull() || type.toString().toLowerCase() == "submit") {
        ...
        overloaded.scenario === undefined
          ? formEl.submit(overloaded.message, overloaded.callback)
          : formEl.submit(overloaded.message, overloaded.scenario);
      }
    }
  ...
  public async submit(message: string, scenario: iScenario): Promise<iScenario>;
  public async submit(
    a?: string | Function | iScenario,
    b?: Function | iScenario
  ): Promise<iScenario> {
